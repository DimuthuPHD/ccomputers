                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="shop_full_width">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img2.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img2.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img3.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img3.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img4.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img4.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img5.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img5.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img6.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img6.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img7.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img7.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img8.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img8.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img9.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img9.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img10.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img10.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img11.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img11.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img12.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img12.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                        ...
                        <div class="product_banner_wrapper">
                            <img src="{{ asset('images/shop/electronics/product_banner_img.jpg') }}" alt="">
                        </div>
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img13.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img13.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img14.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img14.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img15.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img15.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img16.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img16.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img17.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img17.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
                                                ...
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        <div class="product_img">
                                                            <a href="#">
                                                                <img class="first-img"
                                                                    src="{{ asset('images/shop/electronics/li_img18.jpg') }}"
                                                                    alt="">
                                                                <img class="hover-img"
                                                                    src="{{ asset('images/shop/electronics/li_hover_img18.jpg') }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                        <div class="cc_li_img_text">
